    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <p><h5>Date of birth: ${customerDto.dateOfBirth.format(formatter)}</h5>
            ...
            <div class="col">
                ...
                <ul>
                    <core:forEach items="${ordersDto}" var="order">
                        <li>
                            <p><h6>Purchase date: ${order.dateOfSale.format(formatter)}, payment
                            method: ${order.paymentMethod}, delivery method: ${order.deliveryMethod}, payment
                            status: ${order.paymentStatus}, order status: ${order.orderStatus}, total:
                            $${order.total}</h6>
